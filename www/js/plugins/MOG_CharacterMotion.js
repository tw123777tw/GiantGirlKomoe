 ...
 * 要激活事件中的效果，只需使用这些注释。
 *
 * Breath Mode : X          *(1..3) 呼吸模式
 *  
 * Float Mode               浮动模式（上下浮动）
 *
 * Swing Mode               摇摆模式
 *
 * Ghost Mode : X           *(1..2) 幽灵模式
 *
 * =============================================================================
 * 插件命令
 * =============================================================================
 * 激活角色效果ID设置为0，则意味效果将在主玩家启用：
 *
 * breath_mode_follower_id : ID : EFFECT     (1..3) //呼吸模式
 * ghost_mode_follower_id : ID : EFFECT      (1..2) //幽灵模式
 * float_mode_follower_id : ID      //浮动模式
 * swing_mode_follower_id : ID      //摇摆模式
 * shake_effects_follower_id : ID : DURATION   //晃荡_ID_持续时间
 * collapse_effect_follower_id : ID : EFFECT     (1..3) //崩塌_ID_效果编号
 * rotation_follower_id : ID : ROTATION_VALUE  //旋转_ID_旋转数值
 * zoom_follower_id : ID : ZOOM_VALUE    //放大_ID_放大数值
 * clear_effects_follower_id : ID        //清除效果_ID 
 *
 * =============================================================================
 * 要激活事件中的效果，请使用下面的插件指令：
 *
 * breath_mode_event_id : ID : EFFECT       (1..3) //呼吸模式
 * ghost_mode_event_id : ID : EFFECT        (1..2) //幽灵模式
 * float_mode_event_id : ID       //浮动模式
 * swing_mode_event_id : ID       //摇摆模式
 * shake_effects_event_id : ID : DURATION   //晃荡_ID_持续时间
 * collapse_effect_event_id : ID : EFFECT   (1..3) //崩塌_ID_效果编号
 * rotation_event_id : ID : ROTATION_VALUE   //旋转_ID_旋转数值
 * zoom_event_id : ID : ZOOM_VALUE      //放大_ID_放大数值
 * clear_effects_event_id : ID          //清除效果_ID 
 *
 * =============================================================================
 * 例子
 * =============================================================================
