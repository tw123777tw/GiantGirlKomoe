...
//=============================================================================
/*:
 * @plugindesc <QPlus>核心插件             [R1]
 * @version 1.7.1
 * @author Quxios  | Version 1.6.3   ❀汉化:硕明云书
 * @site https://quxios.github.io/
 * @updateurl https://quxios.github.io/data/pluginsMin.json
 *
 * @param Quick Test
 * @text 快速测试
 * @desc 当为true，游戏跳过标题界面并开始新的游戏
 * @type Boolean
 * @default true
 *
 ...
 * **没有图块地图**
 * ----------------------------------------------------------------------------
 * 你可以通过在地图上添加这个注释来禁用地图。
 * ~~~
 * <noTilemap>
 * ~~~
 * 这将用一个简单轻巧的精灵容器来替换图块地图。使用这个可能会提高性能。所以
 * 如果你有一个不使用任何图块且是全视差的地图，那你就应该考虑使用这个。
 *
 * 注意，这有一个可能，如果它们调用在原始图块地图上的类的功能可能会打断一些插件*
 *
 * ============================================================================
 * ## 格式插件命令
 * ============================================================================
 ...
 * **Spaces in arg**
 * ----------------------------------------------------------------------------
 * 每个arg用一个空格隔开。但有时你可能需要一个空间，例如当传递文件名时。
 * 为了做到这一点，你只需要用引号包住它，然后它就可以作为一个单一的arg传递。
 * 例如：
 * ~~~
 ...
 * ~~~
 * 当插件命令运行时，将用变量1的值替换。如果变量1的值是10，
 * 那么你的插件的命令格式为：` qplugin CMD arg1 chara10 `
 * ----------------------------------------------------------------------------
 * **开关**
 * ----------------------------------------------------------------------------
 * 如果你想在插件命令中使用开关的值，可以使用以下格式：
 * ~~~
 * {sID}
 * ~~~
 * - ID: 这是要使用的开关的ID
 ...
 * qPlugin cmd arg1 {s1}
 * ~~~
 * 当插件命令运行时，将用开关1的值替换。如果开关1的价值是true，
 * 那么你的插件的命令格式为：`qPlugin cmd arg1 true`
 *
 * ============================================================================
 * ## 插件命令
 * ============================================================================
 ...
 * **全局锁**
 * ----------------------------------------------------------------------------
 * 这个插件将“锁住”所有人物或某一人物。通过锁定我的意思是你可以锁住他们的
 * 运动或者运动和人物的动画。
 * ~~~
 ...
 * - [人物] - 可选，要应用或忽略“人物 Ids”的列表。用空格分隔开。
 *  * CHARAID: The character identifier.
 *  * 人物ID: 人物标识符。
 *   - For player: 0, p, or player
 *   - For events: EVENTID, eEVENTID, eventEVENTID or this for the event that called this
 *   (replace EVENTID with a number)
 *   - For events: EVENTID, eEVENTID, eventEVENTID 或这个事件的名称(把EVENTID替换成一个数字)
 *
 * 可选选项:
